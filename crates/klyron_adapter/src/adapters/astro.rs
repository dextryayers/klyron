...
impl FrameworkAdapter for AstroAdapter {
    ...
    fn supported_versions(&self) -> Vec<&'static str> { vec!["4.0", "5.0"] }
...
"#)?;
        ...
        std::fs::write(project_dir.join("src/components/Header.astro"),
            r#"<header>
  <nav>
    <a href="/">Home</a>
  </nav>
...
"#)?;
        ...
        std::fs::write(project_dir.join("src/styles/global.css"),
            r#"* { margin: 0; padding: 0; box-sizing: border-box; }
body { font-family: system-ui, sans-serif; }
"#)?;

        std::fs::write(project_dir.join("public/robots.txt"),
            r#"User-agent: *\nAllow: /\n"#)?;
        ...
        std::fs::write(project_dir.join(".prettierrc"),
            r#"{"semi": false, "singleQuote": true, "tabWidth": 2, "trailingComma": "es5", "printWidth": 100, "plugins": ["prettier-plugin-astro"]}"#)?;
